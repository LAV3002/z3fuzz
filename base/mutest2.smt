...
; body
(define-fun T41 () (_ BitVec 64) ( _ bv13164898293160144923 64 ))
(define-fun T40 () (_ BitVec 64) ( _ bv11774740551175106108 64 ))
(define-fun T39 () (_ BitVec 64) ( mlshr T40 T41 ))
(define-fun T38 () (_ BitVec 64) ( msdiv SV3 T39 ))
(define-fun T37 () (_ BitVec 64) ( _ bv14461532240034770438 64 ))
(define-fun T36 () (_ BitVec 64) ( _ bv4546377250472782510 64 ))
(define-fun T35 () (_ BitVec 64) ( meq T36 T37 ))
(define-fun T34 () (_ BitVec 64) ( mlshr T35 T38 ))
(define-fun T33 () (_ BitVec 64) ( mnot T34 ))
(define-fun T32 () (_ BitVec 64) ( mnot T33 ))
(define-fun T31 () (_ BitVec 64) ( _ bv11774740551175106108 64 ))
(define-fun T30 () (_ BitVec 64) ( _ bv11774740551175106108 64 ))
(define-fun T29 () (_ BitVec 64) ( mlshr T30 T31 ))
...
(define-fun T21 () (_ BitVec 64) ( _ bv3984807846243667499 64 ))
(define-fun T20 () (_ BitVec 64) ( mlshr T21 T22 ))
(define-fun T19 () (_ BitVec 64) ( mnot T20 ))
(define-fun T18 () (_ BitVec 64) ( mand T19 T25 ))
(define-fun T17 () (_ BitVec 64) ( meq T18 T32 ))
(define-fun T16 () (_ BitVec 64) ( mnot SV3 ))
(define-fun T15 () (_ BitVec 64) ( _ bv11774740551175106108 64 ))
(define-fun T14 () (_ BitVec 64) ( _ bv16893914304802519511 64 ))
(define-fun T13 () (_ BitVec 64) ( _ bv573276337348005004 64 ))
(define-fun T12 () (_ BitVec 64) ( msdiv SV2 T13 ))
(define-fun T11 () (_ BitVec 64) ( mlshr T12 T14 ))
(define-fun T10 () (_ BitVec 64) ( msge T11 T15 ))
(define-fun T9 () (_ BitVec 64) ( mor T10 T16 ))
...
(define-fun T1 () (_ BitVec 64) ( meq T2 T8 ))
(define-fun T0 () (_ BitVec 64) ( mslt T1 T17 ))
; epilog
(assert (= T0 (_ bv1 64)))
(check-sat)
