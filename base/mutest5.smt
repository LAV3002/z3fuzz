...
; body
(define-fun T27 () (_ BitVec 64) ( _ bv237956085234811923 64 ))
(define-fun T26 () (_ BitVec 64) ( mnot T27 ))
(define-fun T25 () (_ BitVec 64) ( _ bv7952241529059464087 64 ))
(define-fun T24 () (_ BitVec 64) ( msrem SV2 T25 ))
...
(define-fun T20 () (_ BitVec 64) ( msdiv T21 T24 ))
(define-fun T19 () (_ BitVec 64) ( msdiv SV3 T20 ))
(define-fun T18 () (_ BitVec 64) ( msdiv T19 T26 ))
...
(define-fun T5 () (_ BitVec 64) ( mnot SV2 ))
(define-fun T4 () (_ BitVec 64) ( mnot SV3 ))
(define-fun T3 () (_ BitVec 64) ( mnot T4 ))
(define-fun T2 () (_ BitVec 64) ( mudiv T3 T5 ))
(define-fun T1 () (_ BitVec 64) ( msle T2 T6 ))
